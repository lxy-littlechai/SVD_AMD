...
void TopFunc(ap_uint<DDR_WIDTH>* dataIn0, ap_uint<DDR_WIDTH>* dataIn1,
             ap_uint<DDR_WIDTH>* dataOut0, ap_uint<DDR_WIDTH>* dataOut1,
...
#pragma HLS INTERFACE m_axi offset = slave latency = 64 num_write_outstanding = 16 num_read_outstanding = \
    16 max_write_burst_length = 64 max_read_burst_length = 64 bundle = gmem1 port = dataIn1 depth = 8192
#pragma HLS INTERFACE m_axi offset = slave latency = 64 num_write_outstanding = 16 num_read_outstanding = \
    16 max_write_burst_length = 64 max_read_burst_length = 64 bundle = gmem1 port = dataOut1 depth = 8192
